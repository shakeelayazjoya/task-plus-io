...
const PricingPlanHalfYearSection = () => {
  return (
    <>
      <div className="section-title text-center">
        <h2 className="title">All Plans Billed 6 Monthly</h2>
      </div>
...
export default PricingPlanHalfYearSection;
